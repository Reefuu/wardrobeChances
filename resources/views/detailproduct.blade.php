        ...
        <div class="card mb-5 mt-2 mx-auto d-none d-md-block shadow p-3 mb-4  rounded" style="width: 1000px;">
            <div class="row g-0">
                ...
                <div class="col-md-6 ms-5" style="font-family: 'lexend';">
                    <div class="card-body ">
                        <div class="d-flex">
                            <h3 class="mb-3" style="font-weight: 520">{{ $product['name'] }}</h3> <a class="ms-2"
                                href="/wishlist"><img src="{{ asset('pictures/lovekosong.png') }}" style="width: 34px"
                                    alt="logo" class="my-auto me-1 "></a>
                            </a>
                        </div>
