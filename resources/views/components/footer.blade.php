<div class="text-center py-3 " style="background-color: #fbd9c0">
    ...
    <div class="container text-center " style="width: 200px">
        <div class="row">
            ...
            <div class="col">
                <a href="https://www.tiktok.com/@wardrobechances?_t=8WxjTjl4Aao&_r=1" target="_blank"><img src={{ asset('pictures/4.svg') }}
                        class="card-img-top" alt="..."></a>
            </div>
        </div>
    </div>
...
<div class="text-center p-1 pt-4" style="color: #5e5e5e; background-color: #f7e1d0">
